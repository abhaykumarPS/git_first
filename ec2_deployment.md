---
# User change
title: "Deploy single instance of PostgreSQL"
...
```
**NOTE:** We have used dump.sql file to create table and insert values into database.
...
```
**NOTE:-** Replace `{public_ip of instance where Postgresql deployed}` which we have created through the `.yml` file. 
```console
sudo su postgres psql
```
![image](https://user-images.githubusercontent.com/92078754/215392554-9b99d2bb-8598-4af0-a2c8-47e44fddef95.png)

We can use below commands for show our databases and tables.
